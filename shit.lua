if game.CoreGui:FindFirstChild("shit") then
    game.CoreGui.shit:Destroy()
 end
 ...
 local shit = Instance.new("ScreenGui")
 shit.Name = "TF"
 shit.Parent = game.CoreGui
 ...
 getgenv().GUI_Color = {
    Bacground = Color3.fromRGB(63, 63, 70),
 ...
 function Mainholder:Window(hubname, gamename)
    ...
    LeftFrame.BackgroundColor3 = Color3.fromRGB(63, 63, 70)
    ...
    SettingsFrame.BackgroundColor3 = Color3.fromRGB(63, 63, 70)
 ...
 --[[
    ...
    Bind.BackgroundColor3 = Color3.fromRGB(63, 63, 70)
 ...
 local UIS = game:GetService('UserInputService')
   ...
   UserInputService.InputBegan:Connect(
    function(io, p)
       if io.KeyCode == Enum.KeyCode[game:GetService("CoreGui").shit.MainSettingsFrame.MainSettingsContainer.Bind.BText.Text] then
 ...
 function Tabs:Tab(Title)
    ...
    TabGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(178, 102, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(126, 51, 255))}
 ...
 --           local NewFileClone = game:GetService("CoreGui").shit.InternalUIFrame.FilesFrame.FilesHolder.SavedFiles:Clone()
 ...
 function Mainholder:setTheme(Tab)
    Tab:Colorpicker("DarkContrast", Color3.fromRGB(35, 35, 35), function(t)
       for i,v in pairs(game:GetService("CoreGui").shit.MainFrame.ContainerHold:GetDescendants()) do
          if v.ClassName == "TextButton" then
    ...
    Tab:Colorpicker("Background Color", Color3.fromRGB(27, 27, 27), function(t)
       game:GetService("CoreGui").shit.MainFrame.BackgroundColor3 = t
